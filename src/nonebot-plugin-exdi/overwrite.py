...
if nonebot.get_adapters():
	raise RuntimeError('You have already loaded adapters, overwriting handle_event won\'t work, you should load these plugin before loading adapters.')
